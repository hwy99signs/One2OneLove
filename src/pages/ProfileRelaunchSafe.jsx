...
const COPY = {
  en: {
    title: 'My Profile', subtitle: 'Choose what helps One2OneLove personalize your experience and what other members may discover.', edit: 'Edit Profile', save: 'Save Changes', saving: 'Saving…', cancel: 'Cancel',
    ...
    publicTitle: 'What other members can discover', publicNote: 'Member discovery may show your name, profile image, short bio, general location, relationship status and member-since date. Your account email, anniversary, partner name and Love Language are not included in the member directory.',
    privateTitle: 'Account-private details', privateNote: 'These details remain on your account and are not part of member discovery. Partner email is not collected in the relaunch profile because there is not yet a reviewed partner-linking workflow that needs it.',
