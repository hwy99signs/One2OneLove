...
import { ArrowLeft, Loader2, MessageCircle, Search, UserCheck, UserPlus, Users, X } from 'lucide-react';
...
const COPY = {
  en: { title: 'Find Members', subtitle: 'Discover people in the One2OneLove member directory. Private Chat opens after a connection request is accepted.', search: 'Search name or profile…', loading: 'Loading members…', none: 'No matching members found.', signIn: 'Sign in to discover members.', request: 'Connect', pending: 'Request Pending', cancel: 'Cancel Request', connected: 'Connected', chat: 'Private Chat', sent: 'Connection request sent.', cancelled: 'Connection request canceled.', member: 'One2OneLove member', since: 'Member since', back: 'Back to Community', privacy: 'Relaunch member discovery is intentionally limited to display name, optional profile image, short bio and member-since date. Account email, location, relationship status, partner and billing information stay private.' },
  es: { title: 'Encontrar Miembros', subtitle: 'Descubre personas en el directorio de One2OneLove. El Chat Privado se abre después de aceptar una solicitud de conexión.', search: 'Buscar nombre o perfil…', loading: 'Cargando miembros…', none: 'No se encontraron miembros.', signIn: 'Inicia sesión para descubrir miembros.', request: 'Conectar', pending: 'Solicitud Pendiente', cancel: 'Cancelar Solicitud', connected: 'Conectado', chat: 'Chat Privado', sent: 'Solicitud de conexión enviada.', cancelled: 'Solicitud de conexión cancelada.', member: 'Miembro de One2OneLove', since: 'Miembro desde', back: 'Volver a Comunidad', privacy: 'En el relanzamiento, el descubrimiento se limita a nombre visible, imagen opcional, biografía corta y fecha de ingreso. Correo, ubicación, estado de relación, pareja y facturación permanecen privados.' },
  fr: { title: 'Trouver des Membres', subtitle: 'Découvrez des personnes dans l’annuaire One2OneLove. Le Chat Privé s’ouvre après acceptation d’une demande de connexion.', search: 'Rechercher un nom ou un profil…', loading: 'Chargement des membres…', none: 'Aucun membre correspondant.', signIn: 'Connectez-vous pour découvrir les membres.', request: 'Se Connecter', pending: 'Demande en Attente', cancel: 'Annuler la Demande', connected: 'Connecté', chat: 'Chat Privé', sent: 'Demande de connexion envoyée.', cancelled: 'Demande de connexion annulée.', member: 'Membre One2OneLove', since: 'Membre depuis', back: 'Retour à la Communauté', privacy: 'Pour la relance, la découverte est limitée au nom affiché, à l’image facultative, à la courte bio et à la date d’adhésion. E-mail, localisation, statut relationnel, partenaire et facturation restent privés.' },
  it: { title: 'Trova Membri', subtitle: 'Scopri persone nella directory One2OneLove. Il Chat Privato si apre dopo l’accettazione di una richiesta di connessione.', search: 'Cerca nome o profilo…', loading: 'Caricamento membri…', none: 'Nessun membro corrispondente.', signIn: 'Accedi per scoprire i membri.', request: 'Connetti', pending: 'Richiesta in Attesa', cancel: 'Annulla Richiesta', connected: 'Connesso', chat: 'Chat Privata', sent: 'Richiesta di connessione inviata.', cancelled: 'Richiesta di connessione annullata.', member: 'Membro One2OneLove', since: 'Membro dal', back: 'Torna alla Community', privacy: 'Nel rilancio, la scoperta è limitata a nome visibile, immagine opzionale, breve bio e data di iscrizione. Email, posizione, stato relazione, partner e fatturazione restano privati.' },
  de: { title: 'Mitglieder Finden', subtitle: 'Entdecke Menschen im One2OneLove-Mitgliederverzeichnis. Privater Chat öffnet sich nach Annahme einer Verbindungsanfrage.', search: 'Name oder Profil suchen…', loading: 'Mitglieder werden geladen…', none: 'Keine passenden Mitglieder gefunden.', signIn: 'Melde dich an, um Mitglieder zu entdecken.', request: 'Verbinden', pending: 'Anfrage Ausstehend', cancel: 'Anfrage Abbrechen', connected: 'Verbunden', chat: 'Privater Chat', sent: 'Verbindungsanfrage gesendet.', cancelled: 'Verbindungsanfrage abgebrochen.', member: 'One2OneLove-Mitglied', since: 'Mitglied seit', back: 'Zurück zur Community', privacy: 'Beim Relaunch beschränkt sich die Mitgliedersuche auf Anzeigename, optionales Profilbild, kurze Bio und Beitrittsdatum. Konto-E-Mail, Ort, Beziehungsstatus, Partner- und Abrechnungsdaten bleiben privat.' },
...
export default function FindFriendsRelaunch() {
  ...
  const visible = useMemo(() => {
    ...
    return members.filter((member) => [member.name, member.bio]
