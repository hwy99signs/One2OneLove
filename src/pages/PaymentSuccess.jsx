...
const COPY = {
  en: {
    ...
    trialWelcome: 'Your 7-day trial includes full Exclusive-level access. You were not charged the subscription price today. Your first One2OneLove SMS Love Note send is FREE; every additional send is US$0.29. After 7 days, your membership continues on Premiere at US$9.99/month unless you choose Exclusive or cancel before the trial ends.', activeWelcome: 'Your One2OneLove membership is ready to use. Love Note SMS sends after your complimentary first send are US$0.29 each.',
