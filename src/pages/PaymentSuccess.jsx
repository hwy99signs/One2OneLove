...
const COPY = {
  en: {
    ...
    trialWelcome: 'Your 7-day trial includes Exclusive-level access. You were not charged today. Love Note SMS sending remains locked during the trial. After 7 days, your membership continues on Premiere at $9.99/month unless you choose Exclusive or cancel before the trial ends.', activeWelcome: 'Your One2OneLove membership is ready to use. Your first One2OneLove SMS Love Note send after the first successful paid subscription payment is free; additional sends are $0.29 each.',
  ...
  es: {
    ...
    trialWelcome: 'Tu prueba de 7 días incluye acceso de nivel Exclusive. No se te cobró hoy. El envío de Notas de Amor por SMS permanece bloqueado durante la prueba. Después de 7 días, tu membresía continúa en Premiere por $9.99/mes, a menos que elijas Exclusive o canceles antes de que termine la prueba.', activeWelcome: 'Tu membresía de One2OneLove está lista para usar. Tu primer envío SMS de Nota de Amor después del primer pago exitoso de la suscripción es gratis; los envíos adicionales cuestan $0.29 cada uno.',
  ...
  fr: {
    ...
    trialWelcome: 'Votre essai de 7 jours comprend l’accès de niveau Exclusive. Aucun prélèvement aujourd’hui. L’envoi de Notes d’Amour par SMS reste bloqué pendant l’essai. Après 7 jours, votre abonnement continue avec Premiere à 9,99 $/mois, sauf si vous choisissez Exclusive ou annulez avant la fin de l’essai.', activeWelcome: 'Votre abonnement One2OneLove est prêt à être utilisé. Votre premier envoi SMS de Note d’Amour après le premier paiement réussi de l’abonnement est gratuit ; les envois supplémentaires coûtent 0,29 $ chacun.',
  ...
  it: {
    ...
    trialWelcome: 'La prova di 7 giorni include accesso di livello Exclusive. Oggi non è stato effettuato alcun addebito. L’invio di Note d’Amore via SMS resta bloccato durante la prova. Dopo 7 giorni, l’abbonamento continua con Premiere a $9.99/mese salvo scelta di Exclusive o annullamento prima della fine della prova.', activeWelcome: 'Il tuo abbonamento One2OneLove è pronto da usare. Il primo invio SMS di una Nota d’Amore dopo il primo pagamento riuscito dell’abbonamento è gratuito; gli invii aggiuntivi costano $0.29 ciascuno.',
  ...
  de: {
    ...
    trialWelcome: 'Ihr 7-Tage-Test enthält Exclusive-Zugriff. Heute wurde nichts berechnet. SMS-Liebesnachrichten bleiben während des Tests gesperrt. Nach 7 Tagen läuft Ihre Mitgliedschaft mit Premiere für 9,99 $/Monat weiter, sofern Sie nicht Exclusive wählen oder vor Testende kündigen.', activeWelcome: 'Ihre One2OneLove-Mitgliedschaft ist einsatzbereit. Ihre erste SMS-Liebesnachricht nach der ersten erfolgreichen Abonnementzahlung ist kostenlos; weitere Sendungen kosten je 0,29 $.',
