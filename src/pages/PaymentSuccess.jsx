...
const COPY = {
  en: {
    ...
    trialWelcome: 'Your 7-day trial includes Exclusive-level access. You were not charged today.', activeWelcome: 'Your One2OneLove membership is ready to use.',
  ...
  es: {
    ...
    trialWelcome: 'Tu prueba de 7 días incluye acceso de nivel Exclusive. No se te cobró hoy.', activeWelcome: 'Tu membresía de One2OneLove está lista para usar.',
  ...
  fr: {
    ...
    trialWelcome: 'Votre essai de 7 jours comprend l’accès de niveau Exclusive. Aucun prélèvement aujourd’hui.', activeWelcome: 'Votre abonnement One2OneLove est prêt à être utilisé.',
  ...
  it: {
    ...
    trialWelcome: 'La prova di 7 giorni include accesso di livello Exclusive. Oggi non è stato effettuato alcun addebito.', activeWelcome: 'Il tuo abbonamento One2OneLove è pronto da usare.',
  ...
  de: {
    ...
    trialWelcome: 'Ihr 7-Tage-Test enthält Exclusive-Zugriff. Heute wurde nichts berechnet.', activeWelcome: 'Ihre One2OneLove-Mitgliedschaft ist einsatzbereit.',
