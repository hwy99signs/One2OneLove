      ...
      <section className="relative flex min-h-[900px] items-center justify-center bg-cover bg-center" style={{backgroundImage:`url(${HERO})`}}>
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 pb-8 pt-8 text-center text-white">
          ...
          <div className="mx-auto mt-7 grid w-[70%] max-w-[33.6rem] grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <button onClick={() => go('PodcastsSupport')} className="rounded-2xl bg-orange-500 px-[1.4rem] py-[0.525rem] text-[1.375rem]/[1.925rem] font-extrabold shadow-xl hover:bg-orange-600">🎙 Podcast</button>
