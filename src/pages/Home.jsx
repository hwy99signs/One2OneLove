...
const COPY = {
  en: {
    ...
    toolLabels: {
      ...
      relationshipSupport: "Relationship Support", relationshipGoals: "Relationship Goals", lgbtqSupport: "LGBTQ Support", relationshipGames: "Games",
  ...
  es: {
    ...
    toolLabels: {
      ...
      relationshipSupport: "Apoyo para Relaciones", relationshipGoals: "Metas de Relación", lgbtqSupport: "Apoyo LGBTQ", relationshipGames: "Juegos",
  ...
  it: {
    ...
    toolLabels: {
      ...
      relationshipSupport: "Supporto Relazionale", relationshipGoals: "Obiettivi di Coppia", lgbtqSupport: "Supporto LGBTQ", relationshipGames: "Giochi",
  ...
  de: {
    ...
    toolLabels: {
      ...
      relationshipSupport: "Beziehungsunterstützung", relationshipGoals: "Beziehungsziele", lgbtqSupport: "LGBTQ-Unterstützung", relationshipGames: "Spiele",
...
const TOOLS = [
  ...
  ["🎮", "relationshipGames", "Games", "from-yellow-300 to-amber-400"],
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
            {TOOLS.map(([icon,labelKey,page,gradient], index) => (
              <button key={page} onClick={() => {setSelectedTool(index); go(page);}} className={`min-h-[86px] rounded-2xl bg-gradient-to-r ${gradient} ${page === 'Games' ? 'text-slate-950' : 'text-white'} text-xl font-extrabold px-5 shadow-lg hover:scale-[1.02] transition-transform ${index===selectedTool ? 'ring-4 ring-rose-400 ring-offset-2' : ''}`}>
