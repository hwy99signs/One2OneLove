...
const COPY = {
  en: {
    ...
    supportCol: "Support", company: "Company", help: "Help Center", contact: "Contact Us", privacy: "Privacy Policy", terms: "Terms of Service", about: "About Us", suggestions: "Suggestions", reviews: "Reviews",
  ...
  es: {
    ...
    supportCol: "Soporte", company: "Compañía", help: "Centro de ayuda", contact: "Contáctanos", privacy: "Privacidad", terms: "Términos de servicio", about: "Sobre nosotros", suggestions: "Sugerencias", reviews: "Reseñas", copyright: "© 2026 One2OneLove. Hecho con ❤️ para relaciones más saludables."
  },
  fr: {
    ...
    <div className="min-h-screen bg-white text-slate-950 overflow-x-hidden">
      ...
      <footer className="bg-gradient-to-r from-cyan-400 to-blue-500 text-white px-6 py-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-[1.3fr_1fr_1fr] gap-12">
          ...
          <div><h4 className="text-xl font-black mb-4">{t.company}</h4><FooterLink onClick={() => go("AboutUs")}>{t.about}</FooterLink><FooterLink onClick={() => go("Suggestions")}>{t.suggestions}</FooterLink><FooterLink onClick={() => go("Reviews")}>{t.reviews}</FooterLink></div>
        </div>
