...
const copy = {
  ...
  fr: {
    ...
    goals:['Objectifs de Relation','Fixez des objectifs significatifs et suivez vos progrès ensemble.'], quizzes:['Quiz Relationnels','Utilisez des quiz d’auto-réflexion pour mieux comprendre communication, conflit et schémas relationnels.'], communication:['Pratique de Communication','Entraînez-vous à des réponses plus saines dans des scénarios réalistes.'], articles:['Bibliothèque des Relations','Lisez des articles pratiques One2OneLove sur la communication, la confiance, les rencontres, le mariage et la réparation.'], podcasts:['Podcasts','Explorez des podcasts et conversations sur les grands sujets relationnels.'],
