...
export default function CreatorProgramming() {
  ...
  const submit = async (event) => {
    ...
    if (!title.trim() || !startTime || !policyAcknowledged) return;
    ...
    setBooking(true);
    try {
      await bookCreatorProgrammingSlot({ title, description, startsAt: starts.toISOString(), endsAt: ends.toISOString(), timezone, contentMode: mode, replayUrl, policyAcknowledged });
