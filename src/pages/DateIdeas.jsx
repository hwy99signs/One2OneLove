                ...
                <Card key={idea.id} className="border-purple-100 shadow-sm">
                  ...
                  <CardContent>
                    ...
                    <div className="mt-5 flex flex-wrap gap-2">
                      ...
                      <Button size="sm" variant="outline" onClick={() => { setEditing(idea); setShowForm(true); }}>{t.updated.replace(/\.$/, "")}</Button>
