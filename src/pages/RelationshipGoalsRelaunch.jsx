  ...
  return (
    <Card className="border-0 shadow-lg">
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-2 text-sm text-gray-500"><Calendar className="h-4 w-4" /><span>{t.target}: {target && !Number.isNaN(target.getTime()) ? target.toLocaleDateString() : '—'}</span></div>
