...
export default function PrivacyCenter() {
  ...
  const submit = async (type) => {
    ...
    setBusy(type);
    try {
      const before = requests.find((item) => item.request_type === type && ['submitted', 'in_review', 'awaiting_fulfillment'].includes(item.status));
