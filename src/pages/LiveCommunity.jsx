...
const copy = {
  en: {
    ...
    programmingTitle: "Programming & community-content notice", programmingText: "Live rooms may include member conversations, O2OL-created programming, invited creator programming, replays, and AI-assisted conversation prompts. Views expressed by members or independent creators are their own and are not professional medical, mental-health, legal, financial, or crisis advice from One2OneLove.",
  ...
  es: {
    ...
    programmingTitle: "Aviso sobre programación y contenido comunitario", programmingText: "Las salas en vivo pueden incluir conversaciones de miembros, programación creada por O2OL, programación de creadores invitados, repeticiones y temas de conversación asistidos por IA. Las opiniones de miembros o creadores independientes son propias y no constituyen asesoramiento profesional médico, de salud mental, legal, financiero o de crisis de One2OneLove.",
  ...
  fr: {
    ...
    programmingTitle: "Avis sur la programmation et le contenu communautaire", programmingText: "Les salons en direct peuvent inclure des conversations de membres, des programmes créés par O2OL, des programmes de créateurs invités, des rediffusions et des sujets assistés par IA. Les opinions des membres ou créateurs indépendants leur appartiennent et ne constituent pas des conseils professionnels médicaux, psychologiques, juridiques, financiers ou de crise de One2OneLove.",
  ...
  it: {
    ...
    programmingTitle: "Avviso su programmazione e contenuti della community", programmingText: "Le stanze live possono includere conversazioni tra membri, programmazione creata da O2OL, programmi di creator invitati, repliche e spunti assistiti dall’IA. Le opinioni espresse da membri o creator indipendenti sono personali e non costituiscono consulenza professionale medica, psicologica, legale, finanziaria o di emergenza da parte di One2OneLove.",
  ...
  de: {
    ...
    programmingTitle: "Hinweis zu Programmierung und Community-Inhalten", programmingText: "Live-Räume können Gespräche von Mitgliedern, von O2OL erstellte Programme, Programme eingeladener Creator, Wiederholungen und KI-gestützte Gesprächsimpulse enthalten. Aussagen von Mitgliedern oder unabhängigen Creatorn sind deren eigene und stellen keine professionelle medizinische, psychologische, rechtliche, finanzielle oder Krisenberatung durch One2OneLove dar.",
  ...
  nl: {
    ...
    programmingTitle: "Melding over programmering en community-inhoud", programmingText: "Livekamers kunnen gesprekken van leden, door O2OL gemaakte programmering, programmering van uitgenodigde makers, herhalingen en AI-ondersteunde gespreksprompts bevatten. Meningen van leden of onafhankelijke makers zijn van henzelf en vormen geen professionele medische, mentale, juridische, financiële of crisishulp van One2OneLove.",
