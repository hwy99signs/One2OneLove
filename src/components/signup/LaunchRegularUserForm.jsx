        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Field htmlFor="signup-password" label={`${t.password} *`} icon={<Lock size={20}/>}>
              <Input id="signup-password" type={showPassword?'text':'password'} value={formData.password} onChange={e => setFormData({...formData,password:e.target.value})} placeholder={t.passwordPlaceholder} className="pl-12 pr-12" minLength={8} required/>
            ...
            <Field htmlFor="signup-confirm-password" label={`${t.confirmPassword} *`} icon={<Lock size={20}/>}>
              <Input id="signup-confirm-password" type={showConfirmPassword?'text':'password'} value={formData.confirmPassword} onChange={e => setFormData({...formData,confirmPassword:e.target.value})} placeholder={t.confirmPasswordPlaceholder} className="pl-12 pr-12" minLength={8} required/>
