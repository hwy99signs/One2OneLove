      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pb-10 sm:pb-12 text-center">
        ...
        <div className="flex flex-col items-center gap-4 max-w-4xl mx-auto mb-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 w-full">
            ...
            <Link to={createPageUrl("MyMatchIQ")}>
              <Button 
                size="lg"
            ...
            >
              <Button 
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg px-8 py-6 rounded-2xl shadow-2xl transform hover:scale-105 transition-all"
              >
