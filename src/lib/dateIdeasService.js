...
/**
 * Saving a built-in idea creates a private member-owned copy using only columns that
 * actually exist in custom_date_ideas. Repeated saves are suppressed by an own-row
 * title/description match so the same built-in idea does not pile up duplicates.
 */
