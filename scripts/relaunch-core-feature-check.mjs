...
check('Date Ideas page truthfully labels private tools staged', browse.includes('Private Date Idea tools are staged') && /saving, creating, favoriting and completion tracking/i.test(browse), 'Preview must not imply private persistence is already active.');
